    ...
    <div class="profile">
        ...
        <div class="bigBox">
            ...
            <div class="nameProfile">
                ...
                <input type="text" name="newName" value="<?= isset($_SESSION["usuario"]["name"]) ? $_SESSION["usuario"]["name"] : "" ?>">
            </div>
            <div class="bioProfile">
                <p class="nameTwo">BIO</p>
                <textarea type="text" name="newBio"><?= isset($_SESSION["usuario"]["bio"]) ? $_SESSION["usuario"]["bio"] : "" ?></textarea>
            </div>
            <div class="phoneProfile">
                <p class="nameThree">PHONE</p>
                <input type="text" name="newPhone" value="<?= isset($_SESSION["usuario"]["phone"]) ? $_SESSION["usuario"]["phone"] : "" ?>">
            </div>
            </form>
